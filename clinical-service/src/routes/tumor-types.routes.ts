...
import { TumorTypesController } from '../controllers/tumor-types.controller';
 ...
 *                   type: integer
 */
router.get('/', TumorTypesController.getAllTumorTypes);
 ...
 */
router.get('/search', TumorTypesController.searchTumorTypes);
 ...
 */
router.post('/', validateRequest(CreateTumorTypeDto), TumorTypesController.createTumorType);
 ...
 */
router.get('/:id', TumorTypesController.getTumorTypeById);
