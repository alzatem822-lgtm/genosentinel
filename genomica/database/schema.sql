...
-- Datos de ejemplo para PatientVariantReport (asumiendo patientId del microservicio clínica)
INSERT INTO PatientVariantReport (uuid, patientId, variantId, detectionDate, alleleFrequency) VALUES
(UUID(), 1, 1, '2024-01-15', 0.4523),
(UUID(), 1, 4, '2024-01-15', 0.3812),
(UUID(), 2, 2, '2024-02-20', 0.5234),
(UUID(), 3, 3, '2024-03-10', 0.6123),
(UUID(), 3, 6, '2024-03-10', 0.4567);
*/